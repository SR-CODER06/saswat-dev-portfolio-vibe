  ...
  return (
    <section id="skills" className="py-20 section-padding">
      <div className="container mx-auto">
              ...
              <div className="flex flex-wrap gap-2 justify-center">
                {category.skills.map((skill, skillIndex) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    whileHover={{ y: -3 }}
                    className="bg-primary/10 text-primary px-4 py-2 rounded-lg text-sm"
                  >
                    {skill}
                  </motion.div>
                ))}
        ...
        >
          <div className="bg-gradient-to-r from-primary/20 via-secondary/20 to-accent/20 p-6 rounded-xl text-center">
