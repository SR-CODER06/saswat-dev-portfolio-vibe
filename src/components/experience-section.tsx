      ...
      <div className="container mx-auto" ref={containerRef}>
        ...
        <div className="relative h-[300vh]">
          {experiences.map((experience, index) => (
            <motion.div
              key={index}
              className="sticky top-[30vh] h-[40vh] flex items-center justify-center px-4"
              style={{ opacity: 0 }}
              animate={{
                opacity: 1,
              }}
              ...
              <div className="flex gap-6 w-full max-w-4xl mx-auto">
                ...
                <div className="relative">
                  ...
                  {index !== experiences.length - 1 && (
                    <div className="absolute top-16 h-[calc(100vh-16rem)] left-6 w-0.5 bg-muted-foreground/20 -z-10">
                      <motion.div 
