  ...
  const cardVariants = {
    ...
    visible: (i: number) => ({
      ...
      transition: {
        ...
        damping: 25,
        stiffness: 100,
        delay: i * 0.1, // Reduced delay for better performance
      },
    }),
  };
  ...
  return (
    <section id="experience" className="py-20 bg-muted/30 min-h-screen relative overflow-hidden">
      ...
      <div className="container mx-auto" ref={containerRef}>
        ...
        {/* Sticky container */}
        <div className="sticky top-24 py-10 h-[calc(100vh-10rem)]">
          <div className="max-w-4xl mx-auto h-full" ref={cardsContainerRef}>
                      ...
                      <div className="flex flex-wrap gap-2 mt-6">
                        {experience.skills.map((skill, skillIndex) => (
                          <motion.span 
                            ...
                            transition={{ delay: 0.3 + skillIndex * 0.05 + index * 0.1 }}
                            whileHover={{ 
